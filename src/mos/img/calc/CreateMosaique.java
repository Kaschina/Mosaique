 ...
 * can be a list, that stores imagevalues - the path and the rgb-value of images
 * or directories that contain images. If wanted, the informations about images
...
public class CreateMosaique {
     ...
     * public constructor.
     *
     * @param tiles the tiles of a sourceImage.
     * @param source the sourceImage.
     * @param numberOfThreads the number of threads
     */
    public CreateMosaique(ArrayList<BufferedImage> tiles, BufferedImage source, int numberOfThreads) {
        this.tiles = tiles;
        ...
        this.frame = new JFrame("testbild");
        this.frame.setVisible(true);
        this.frame.setSize(sourceWidth + 100, sourceHeight + 100);
        this.label = new JLabel();
        this.label.setIcon(new ImageIcon(source));
        this.frame.add(BorderLayout.CENTER, label);
    }

    /**
     * create a mosaiqueImage with informations of a infoFile.
     *
     * @param info the File that stores a list of Imagevalues.
     ...
     *
     * @param mosaiqueSource the directory that contains images.
     * @return mosaique the mosaiqueImage
     */
     ...
     *
     * @param rgbTile the tile to be compared with the mosaiquelist.
     ...
     *
     * @param info the file where mosaiqueList has to be written to.
     */
